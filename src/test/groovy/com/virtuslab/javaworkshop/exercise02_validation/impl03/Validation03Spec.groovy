package com.virtuslab.javaworkshop.exercise02_validation.impl03

import spock.lang.Specification

class Validation03Spec extends Specification {
    ...
    def "should return #expectedResult for #email, #amount"(String email, Double amount, String productId, boolean expectedResult) {
        ...
        Validator<com.virtuslab.javaworkshop.exercise02_validation.ToValidate> validator = Validation03.getValidation()

        when:
        Validation03.ValidationResult result = validator.validate(toValidate)
    ...
    def "should return message for invalid field"() {
        ...
        then:
        result.getInvalidFields().get(0).toString() == "Field: amount has invalid value: -100.0. Amount can't be lower than 0."
